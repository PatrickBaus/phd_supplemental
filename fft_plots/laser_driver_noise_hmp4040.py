            ...
            "files": [
                ...
                },
                {
                    ...
                    "options": {
                        ...
                        "scaling": {
                            "shot_noise_100mA": lambda data: np.ones_like(data["freq"])
                            * np.sqrt(2 * elementary_charge * 0.1),
                            "shot_noise_200mA": lambda data: np.ones_like(data["freq"])
                            * np.sqrt(2 * elementary_charge * 0.18),
                            "shot_noise_20mA": lambda data: np.ones_like(data["freq"])
                            * np.sqrt(2 * elementary_charge * 0.02),
                        },
                    },
                },
            ],
