...
plot = {
    ...
    "files": [
        {
            "filename": "xy_plots/DgDrive-2-3-1_Tempco_2021-03-23_14:41:01+00:00.zip",  # Fixed direction. Going up now
            "show": True,
            "parser": "ltspice_fets",
            "options": {
                "skiprows": 7,
                ...
                "scaling": {
                    ...
                    "value": lambda x: (x["value"] - x["value"][x.date >= "2021-03-27 01:00:00"].min())
                    / 10,  # in A and relative coordinates
                },
            },
        },
    ],
